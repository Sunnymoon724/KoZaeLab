namespace Gpm.Ui
{
    ...
    public partial class InfiniteScroll : IMoveScroll
    {
        ...
        {
            return viewportSize > contentSize ? true : (-position > -contentSize*0.0001f);
        ...
        {
            return viewportSize > contentSize ? true : -(viewportSize+position-contentSize) <= contentSize*0.0001f;
