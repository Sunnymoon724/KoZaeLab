	...
	public class MotionEditorController : MonoBehaviour
	{
		...
		private GameObject Target
		{
			...
			set
			{
				...
				{
					LogSvc.System.W("Prefab must have animator component");

					return;
				}

				if(!value.HasComponent<MotionController>())
				{
					LogSvc.System.W("Prefab must have motionController component");
		...
		{
			LogSvc.System.I("it is being developed.");
		}
	}
}
#endif