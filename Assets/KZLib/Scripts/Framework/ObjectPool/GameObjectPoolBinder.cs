...
{
	/// <summary>
	/// Binds a data list to pooled slots.
	/// Uses GameObjectPool internally and automatically grows or shrinks the slot count to match the data.
	/// GameObjectPool manages the object lifecycle,
	/// while GameObjectPoolBinder manages the mapping between data and objects.
	/// </summary>
