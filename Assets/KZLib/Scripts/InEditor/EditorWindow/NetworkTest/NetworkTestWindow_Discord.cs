...
namespace KZLib.KZWindow
{
	public partial class NetworkTestWindow : OdinEditorWindow
	{
		...
		{
			CommonUtility.PostWebHook_Discord(m_discordLink,"Text Test",new MessageData[] { new("Test","Hello World") },null);
		}
		...
		{
			CommonUtility.PostWebHook_Discord(m_discordLink,"Image Test",new MessageData[] { new("Test","Hello World") },CommonUtility.FindTestImageData());
		}
	}
}
#endif