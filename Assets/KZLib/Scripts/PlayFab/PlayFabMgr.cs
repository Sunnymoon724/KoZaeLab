...
#endif
			LogSvc.System.E($"PlayFabError - [Code : {playFabError.Error} / Message : {playFabError.ErrorMessage} / Details : {JsonConvert.SerializeObject(playFabError.ErrorDetails,Formatting.Indented)}]");
		}
