...
{
	/// <summary>
	/// Base class for KZ custom Odin attribute drawers.
	/// </summary>
	/// <remarks>
	/// When <see cref="m_errorMessage"/> is set, shows an error box and falls back to the default drawer.
	/// </remarks>
	...
	{
		/// <summary>When set, displays an error message instead of the custom drawer.</summary>
		...
		/// <summary>Draws PrefixLabel and returns the value-area rect.</summary>
		...
		/// <summary>Resolves a member value from the parent inspector object by name (e.g. clamp expressions).</summary>
		...
		/// <summary>Label style for validation display. Uses default color when <paramref name="wrongHexColor"/> is null.</summary>
		...
		/// <summary>Draws a color swatch preview with gradient.</summary>
		...
		/// <summary>Returns horizontally divided rects of equal width.</summary>
