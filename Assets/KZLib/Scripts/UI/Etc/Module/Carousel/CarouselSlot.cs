...
{
	public class CarouselSlot : Slot
	{
		[SerializeField,HideInInspector]
		private float m_currentLocation = 0.5f;

		[BoxGroup("Carousel",Order = 6)]
		[VerticalGroup("Carousel/0",Order = 0),SerializeField]
		protected RectTransform m_focusUI = null;

		[VerticalGroup("Carousel/0",Order = 0),ShowInInspector,PropertyRange(0.0f,1.0f)]
		...
		[VerticalGroup("Carousel/0",Order = 0),SerializeField,ReadOnly]
