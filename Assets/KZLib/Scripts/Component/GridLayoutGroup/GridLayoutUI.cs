...
public class GridLayoutUI : BaseComponentUI
{
	...
	private void Initialize()
	{
		...
		m_UIPool = new UIPool(m_Pivot.gameObject,m_Storage);
	...
	{
		var slot = m_UIPool.Get<SlotUI>(m_GridLayout.transform);
	...
	private void RemoveSlot(int _count)
	{
		...
		{
			m_UIPool.Put(m_SlotList[i].gameObject);
		}
