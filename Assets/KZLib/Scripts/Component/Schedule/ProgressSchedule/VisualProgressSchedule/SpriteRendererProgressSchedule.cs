...
{
	public class SpriteRendererProgressSchedule : VisualProgressSchedule
	{
		[SerializeField,LabelText("렌더러 리스트"),ListDrawerSettings(DraggableItems = false),OnValueChanged(nameof(OnChangeGraphic))]
