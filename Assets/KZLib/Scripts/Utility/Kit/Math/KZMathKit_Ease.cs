...
/// <summary>
/// Standard and custom easing curve types used by KZMathKit.GetEaseCurve.
/// </summary>
...
{
	/// <summary>
	/// Returns a preconfigured AnimationCurve for the given ease type.
	/// </summary>
	...
	/// <summary>
	/// Returns a rise-then-fall or fall-then-rise curve depending on whether the animation starts increasing.
	/// </summary>
	public static AnimationCurve GetIncrementalCurve(bool increaseStart)
	{
		return GetEaseCurve(increaseStart ? EaseType.RiseFall : EaseType.FallRise);
	}
}