...
public static class ColorExtension
{
	...
	public static Color Brightness(this Color _color,float _value) => new Color(_color.r+_value,_color.g+_value,_color.b+_value,_color.a);

	/// <summary>
	/// 입력된 색상에 맞는 텍스트 색상을 반환합니다.
	/// </summary>
