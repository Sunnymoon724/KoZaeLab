...
{
	/// <summary>
	/// Platform toggles: vibration and local push (including night). Read by <see cref="KZLib.Natives.VibrationManager"/> and push logic.
	/// </summary>
	public class NativeTune : Tune
	{
		protected NativeTune() { }

		private bool m_useVibration;
		...
		private bool m_useNotification;
		...
		private bool m_useNightNotification;
