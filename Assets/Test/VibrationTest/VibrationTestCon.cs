...
namespace KZLib.KZSample
{
	...
	{
		[SerializeField] private Slider m_timeSlider = null;
		[SerializeField] private TMP_Text m_timeText = null;
		[Space(5)]
		[SerializeField] private Slider m_intensitySlider = null;
		[SerializeField] private TMP_Text m_intensityText = null;
		[Space(5)]
