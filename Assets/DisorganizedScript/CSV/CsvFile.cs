...
//         /// </summary>
//         public CsvRecords Records = new CsvRecords();
...
//                 {
//                     // LogHelper.LogError(string.Concat("There is no record at index", recordIndex.ToString()));
//                     return null;
//                 }
...
//                 if (fieldIndex < 0 || fieldIndex > (record.Fields.Count - 1))
//                 {
//                     // LogHelper.LogError(string.Format("There is no field at index {0} in record {1}.", fieldIndex, recordIndex));
//                     return string.Empty;
//                 }
...
//                 if (fieldIndex < 0)
//                 {
//                     // LogHelper.LogError(string.Concat("There is no field header with the name ", fieldName));
//                     return string.Empty;
//                 }
...
//                     Headers.AddRange(reader.Fields);
//                     addedHeader = true;
//                     continue;
//                 }
...
//                 record.Fields.AddRange(reader.Fields);
//                 Records.Add(record);
//             }
//         }
...
//                 if (record.FieldCount > fieldIndex)
//                 {
...
//             {
//                 CsvRecord record = Records[i];
//                 if (record.FieldCount < HeaderCount)
//                 {
//                     Records.RemoveAt(i);
//                 }
//             }
