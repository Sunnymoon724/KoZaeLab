...
//             using(StreamWriter writer = new StreamWriter(msWriter, encoding ?? Encoding.Default))
//             {
//                 WriteToStream(csvFile, writer);
//                 writer.Flush();
//             }            
...
//             using(StreamReader reader = new StreamReader(msReader, encoding ?? Encoding.Default))
//             {
...
//             for(var i = 0; i < csvFile.Records.Count; ++i)
//             {
//                 WriteRecord(csvFile.Records[i].Fields, writer);
//             }
//         }
