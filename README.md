...
| **Required Git** | UniTask, UIEffect, SoftMaskForUGUI, ParticleEffectForUGUI, [NuGetForUnity](https://github.com/GlitchEnzo/NuGetForUnity) |
...
Full documentation covers Scripts folder layout, architecture (Pool/RosterMapper, Facet, MessagePipe, TestMode), samples, config system, KZMenu editor tools, optional modules (PlayFab, IAP), and dependencies.
